...
export default async function AdminUnitNondikDetailPage({
  params,
}: {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-2 text-sm text-gray-500 mb-4">
        <Link href="/admin/units-nondik" className="hover:text-tertiary">
          Unit Non-Pendidikan
        </Link>
      ...
      <div>
        ...
        <p className="text-sm text-gray-500 mt-1">
          Kelola informasi, pengaturan, dan admin untuk kantor/unit non-pendidikan ini.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
        ...
        <div className="lg:col-span-3 space-y-6">
          <Card className="p-6 border-border shadow-sm">
            ...
            <UnitForm initialData={unit as any} isNondik={true} />
          </Card>
        </div>
        ...
        <div className="lg:col-span-2 space-y-6">
          <Card className="p-6 border-border shadow-sm">
            <div className="flex items-center justify-between mb-4 border-b border-border pb-2">
              <h2 className="text-lg font-bold text-primary">Admin / Penanggung Jawab</h2>
              <AssignAdminModal unitId={unit.id} isNondik={true} />
            </div>
              ...
              {unit.userRoles.length === 0 ? (
                ...
                unit.userRoles.map((assignment) => (
                  ...
                  >
                    ...
                    <RemoveAdminButton userId={assignment.userId} unitId={unit.id} isNondik={true} />
                  </div>
                ))
              )}
            </div>
